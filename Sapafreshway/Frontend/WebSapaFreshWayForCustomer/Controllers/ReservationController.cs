...
namespace WebSapaFreshWayForCustomer.Controllers
{
    public class ReservationController : Controller
    {
        ...
        private string _apiUrl = "http://192.168.79.29:5001/api/Reservation";

        public ReservationController(IHttpClientFactory httpClientFactory, ApiService apiService)
        {
            _client = httpClientFactory.CreateClient();
            _apiUrl = $"{apiService.GetApiBaseUrl()}/api/Reservation";
        }
